      ...
      <nav class="mt-2" style="height: auto;">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/detailSentralisasi" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Informasi Sentralisasi</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/detailKategoriMataAnggaran" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kategori Mata Anggaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/detailMataAnggaran" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mata Anggaran</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/detailTransaksiPemasukan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pemasukan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/detailTransaksiPengeluaran" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengeluaran</p>
                </a>
              </li>
