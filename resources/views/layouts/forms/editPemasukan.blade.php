  ...
  <div class="col">
    <div class="card card-primary">
      <div class="card-header">
        <h2 style="font-weight: bold;">Edit Transaksi Pemasukan</h2>
      </div>
      <form action="{{ route('updatePemasukan', $data->id_pemasukan) }}" method="POST" onsubmit="return validateForm()">
        @csrf
        @method('PUT')
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select name="kategori_mata_anggaran" class="form-control" id="kategori_mata_anggaran" value="{{ $data->kategori_mata_anggaran }}">
                <!-- Options will be dynamically populated based on the selected "Induk Kategori Anggaran" -->
              </select>
              <br>
              <label>Mata Anggaran:</label>
              <select name="mata_anggaran" class="form-control" id="mata_anggaran" value="{{ $data->mata_anggaran }}">
                <!-- Options will be dynamically populated based on the selected "Kategori Mata Anggaran" -->
              </select>
              <br>
              <label>Sentralisasi:</label>
              <select name="isSentralisasi" class="form-control" id="isSentralisasi" value="{{ $data->isSentralisasi }}">
                <!-- Options will be dynamically populated based on the selected "Mata Anggaran" -->
              </select>
              <br>
              <label>Tanggal Transaksi:</label>
              <input type="text" class="form-control datepicker" name="tanggal_transaksi" id="tanggal_transaksi" placeholder="Masukkan tanggal transaksi" value="{{ $data->tanggal_transaksi }}"><br>
              <label>Tanggal Warta:</label>
              <input type="text" class="form-control datepicker" name="tanggal_warta" id="tanggal_warta" placeholder="Masukkan tanggal warta" value="{{ $data->tanggal_warta }}"><br>
              <label>Nama Transaksi Pemasukan:</label>
              <input type="text" class="form-control" name="nama_transaksi" id="nama_transaksi" placeholder="Pilih nama transaksi (mata anggaran + tanggal)" value="{{ $data->nama_transaksi }}"><br>
              <label>Jenis Transaksi:</label>
              <select name="jenis_transaksi" class="form-control" id="jenis_transaksi" value="{{ $data->jenis_transaksi }}">
          ...
          <div class="col-md-6">
            ...
            <label>Nomor Transaksi:</label>
              <input type="number" class="form-control" name="nomor_transaksi" id="nomor_transaksi" value="{{ $data->nomor_transaksi }}"placeholder="Masukkan nomor transaksi (tanggal + 4 digit unik)"><br>
              <label>Jumlah Uang:</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">Rp.</span>
                </div>
                <input type="text" class="form-control" name="jumlah_uang" id="jumlah_uang" value="{{ $data->jumlah_uang }}" placeholder="Masukkan jumlah uang" id="jumlah_uang">
              </div>
              <br>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="jumlah_sentralisasi" placeholder="Jumlah Sentralisasi" id="jumlah_sentralisasi" value="{{ $data->jumlah_sentralisasi }}">
              </div>
              <br>
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="jumlah_gereja" placeholder="Jumlah Gereja" id="jumlah_gereja" value="{{ $data->jumlah_gereja }}">
              </div>
              <br>
              <label for="persembahanTahun">Tahun Anggaran:</label>
              <select name="persembahanTahun" id="persembahanTahun" class="form-control" value="{{ $data->persembahanTahun }}"></select><br>
              <label>Bulan Awal:</label>
              <select name="bulan_awal" class="form-control" id="bulan_awal" value="{{ $data->bulan_awal }}">
              ...
              <select name="bulan_akhir" class="form-control" id="bulan_akhir" value="{{ $data->bulan_awal }}">
                <option value="Januari">Januari</option>
                <option value="Februari">Februari</option>
                <option value="Maret">Maret</option>
                <option value="April">April</option>
              ...
              <input type="text" class="form-control" name="keterangan" placeholder="Masukkan Keterangan" value="{{ $data->keterangan }}"><br>
            </div>
          </div>
        </div>
        <div class="row">
