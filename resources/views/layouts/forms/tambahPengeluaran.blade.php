  ...
  <div class="col">
    <div class="card card-primary">
      <div class="card-header">
        <h2 style="font-weight: bold;">Tambah Transaksi Pengeluaran</h2>
      </div>
      <form action="{{ route('buatPengeluaran') }}" method="POST" onsubmit="return validateForm()">
        @csrf
      <div class="card-body">
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="hidden" class="form-control" id="isSentralisasi" disabled>
                <!-- Options will be dynamically populated based on the selected "Mata Anggaran" -->
              </select>
              <!-- <br> -->
              <label>Tanggal Transaksi:</label>
              <input type="text" class="form-control datepicker" name="tanggal_transaksi" placeholder="Masukkan tanggal transaksi"><br>
              <label>Tanggal Warta:</label>
              <input type="text" class="form-control datepicker" name="tanggal_warta" placeholder="Masukkan tanggal warta"><br>
          ...
          <div class="col-md-6">
            <div class="form-group">
            <label>Nama Transaksi Pengeluaran:</label>
              <input type="text" class="form-control" name="nama_transaksi" placeholder="Pilih nama transaksi (mata anggaran + tanggal)"><br> 
            <!-- <label>Nomor Transaksi:</label> -->
              <input type="hidden" class="form-control" id="nomor_transaksi" placeholder="Masukkan nomor transaksi (tanggal + 4 digit unik)">
              <label>Masukkan Jumlah Uang:</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">Rp.</span>
                </div>
                <input type="text" class="form-control" name="jumlah_uang" placeholder="Masukkan jumlah uang" id="jumlah_uang">
              </div>
              <br>
              ...
              <div class="input-group">
                ...
                <input type="hidden" class="form-control" name="jumlah_sentralisasi" placeholder="Jumlah Sentralisasi" id="jumlah_sentralisasi" disabled>
              <!-- </div>
              <br> -->
        ...
        <div class="row">
          <div class="col-12">
            <a type="button" href="/admin/detailTransaksiPengeluaran" class="btn btn-default float-right">Cancel</a>
