...
Route::prefix('admin')->middleware(['isAdmin', 'auth'])->group(function(){
    ...
    Route::get('/kategoriMataAnggaran', [App\Http\Controllers\anggaranController::class, 'index'])->name('kategoriMataAnggaran');
    Route::post('/tambahKategoriMataAnggaran', [App\Http\Controllers\anggaranController::class, 'create'])->name('tambahKategoriMataAnggaran');
    Route::get('/detailKategoriMataAnggaran', [App\Http\Controllers\anggaranController::class, 'index2'])->name('detailKategoriMataAnggaran');
    Route::delete('/deleteKategoriMataAnggaran/{id}', [App\Http\Controllers\anggaranController::class, 'destroy'])->name('deleteKategoriMataAnggaran');
    Route::get('/editKategoriMataAnggaran/{id}', [App\Http\Controllers\anggaranController::class, 'edit'])->name('editKategoriMataAnggaran');
    Route::put('/updateKategoriMataAnggaran/{id}', [App\Http\Controllers\anggaranController::class, 'update'])->name('updateKategoriMataAnggaran');



    // MATA ANGGARAN
    // Route::get('/mataAnggaran', [App\Http\Controllers\mataAnggaranController::class, 'showKategoriMataAnggaranForm'])->name('mataAnggaran');
    // Route::get('/mataAnggaran', [App\Http\Controllers\mataAnggaranController::class, 'showKategoriMataAnggaranForm'])->name('showKategoriMataAnggaranForm');
    Route::get('/mataAnggaran/{id}', [App\Http\Controllers\mataAnggaranController::class, 'index'])->name('mataAnggaran');
    Route::get('/mataAnggaran', [App\Http\Controllers\mataAnggaranController::class, 'index'])->name('mataAnggaranIndex');
    Route::post('/tambahMataAnggaran', [App\Http\Controllers\mataAnggaranController::class, 'create'])->name('tambahMataAnggaran');
    Route::put('/updateMataAnggaran/{id}', [App\Http\Controllers\mataAnggaranController::class, 'update'])->name('updateMataAnggaran');
    Route::delete('/deleteMataAnggaran/{id}', [App\Http\Controllers\mataAnggaranController::class, 'destroy'])->name('deleteMataAnggaran');
    Route::get('/detailMataAnggaran', [App\Http\Controllers\mataAnggaranController::class, 'index2'])->name('detailMataAnggaran');
    Route::get('/editMataAnggaran/{id}', [App\Http\Controllers\mataAnggaranController::class, 'edit'])->name('editMataAnggaran');
    
    // Route::get('/editMataAnggaran/{id}', [App\Http\Controllers\mataAnggaranController::class, 'showKategoriMataAnggaranFormEdit'])->name('kategoriMataAnggaranFormEdit');
    


    //  PEMASUKAN BANG
    // Route::get('/headTransaksi', [App\Http\Controllers\transaksiController::class, 'index3'])->name('headTransaksi');
    Route::get('/detailTransaksiPemasukan', [App\Http\Controllers\pemasukanController::class, 'index2'])->name('detailTransaksiPemasukan');
    Route::get('/tambahPemasukan', [App\Http\Controllers\pemasukanController::class, 'index'])->name('tambahPemasukan');
    Route::get('/rincianPemasukan', [App\Http\Controllers\pemasukanController::class, 'index3'])->name('rincianPemasukan');
    Route::get('/editPemasukan/{id}', [App\Http\Controllers\pemasukanController::class, 'edit'])->name('editPemasukan');
    Route::put('/updatePemasukan/{id}', [App\Http\Controllers\pemasukanController::class, 'update'])->name('updatePemasukan');
    Route::get('/deletePemasukan/{id}', [App\Http\Controllers\pemasukanController::class, 'destroy'])->name('deletePemasukan');  
    Route::get('/tambahPemasukan/{id}', [App\Http\Controllers\pemasukanController::class, 'index'])->name('tambahPemasukanbyId');
    Route::post('/buatPemasukan', [App\Http\Controllers\pemasukanController::class, 'create'])->name('buatPemasukan');
    // Route::get('/headTransaksiDetail', [App\Http\Controllers\pemasukanController::class, 'index4'])->name('headTransaksiDetail');
    // Route::get('/persembahanIbadah', [App\Http\Controllers\pemasukanController::class, 'index'])->name('persembahanIbadah');
    // Route::get('/persembahanJemaat', [App\Http\Controllers\pemasukanController::class, 'index'])->name('persembahanJemaat');

    // TRANSAKSI PENGELUARAN
    Route::get('/detailTransaksiPengeluaran', [App\Http\Controllers\pengeluaranController::class, 'index'])->name('detailTransaksiPengeluaran');
    // Route::get('/pengeluaran', [App\Http\Controllers\pengeluaranController::class, 'index'])->name('pengeluaran');
    Route::get('/tambahPengeluaran', [App\Http\Controllers\pengeluaranController::class, 'index2'])->name('tambahPengeluaran');
    Route::post('/buatPengeluaran', [App\Http\Controllers\pengeluaranController::class, 'create'])->name('buatPengeluaran');
    Route::get('/deletePengeluaran/{id}', [App\Http\Controllers\pengeluaranController::class, 'destroy'])->name('deletePengeluaran');  
